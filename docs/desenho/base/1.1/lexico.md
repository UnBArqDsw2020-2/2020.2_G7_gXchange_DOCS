...
| Classificação | Noção | Impacto | Sinônimos |
| ------------- | ------| ------- | --------- |
| Objeto | Qualquer pessoa que esteja utilizando o sistema, de acordo com o [perfil de usuário](/desenho/base/1.1/personas) definido | O usuário pode publicar, comprar, trocar [jogos](/desenho/base/1.1/lexico/#l4-jogo) | Comprador, vendedor, moderador |
